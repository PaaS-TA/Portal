...
<div id="docoumentsViewArea">
    <div class="panel content-box col-sm-12 col-md-12 mt-5">
        ...
        <div class="panel content-box col-sm-12 col-md-12">
            ...
            <div>
                <table id="noticeTableArea" class="table table-bordered table-hover">
                    <thead>
                    <tr>
                    ...
                    if (resultList[i].important == "true") {
                        ...
                        if (resultList[i].filePath != '') { // 파일 있으면
                            htmlStringImportant.push('<tr id="trID" style="color:rgb(249, 161, 27); font-weight:bold;" >'
                                    ...
                                    + '<td class="col-md-2 tac"><span style="font-size: 15px;">' + resultList[i].classificationValue + '</td>'
                                    + '<td class="col-md-4">'
                                    + '<span id="titleId" style="font-size: 15px;cursor:pointer;" onclick="procMoveNoticeView(\'' + resultList[i].no + '\')">' + resultList[i].title + '</span>'
                                    ...
                                    + '</td>'
                                    + '<td class="col-md-2 tac"><span style="font-size: 15px;">' + resultList[i].startDate.substring(0, 10) + ' ~ ' + resultList[i].endDate.substring(0, 10) + '</td>'
                                    + '</tr>');
                        } else {
                            htmlStringImportant.push('<tr id="trID" style="color:rgb(249, 161, 27); font-weight:bold; ">'
                                    + '<td class="col-md-1 tac"><span style="font-size: 15px;">' + resultList[i].no + '</td>'
                                    + '<td class="col-md-2 tac"><span style="font-size: 15px;">' + resultList[i].classificationValue + '</td>'
                                    + '<td class="col-md-4"><span id="titleId" style="font-size: 15px;cursor:pointer;" onclick="procMoveNoticeView(\'' + resultList[i].no + '\')">' + resultList[i].title + '</span></td>'
                                    + '<td class="col-md-2 tac"><span style="font-size: 15px;">' + resultList[i].startDate.substring(0, 10) + ' ~ ' + resultList[i].endDate.substring(0, 10) + '</td>'
                                    + '</tr>');
                        }
                    }
