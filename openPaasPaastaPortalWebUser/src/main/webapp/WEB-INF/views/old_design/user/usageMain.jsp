...
<div id="usageViewArea" class="ViewArea" style="display: none; position: relative;">
    <div class="col-sm-12 pt20">
        ...
        <div class="fl">
            <p class="mt10 ml20"> 사용중인 앱의 메모리 사용량을 조회합니다. </p>
        </div>
    </div>
    <div class="panel content-box col-sm-12 col-md-12">
        <div class="mr10 fl"> 조직 </div>
        <div class="mr40 fl">
            <select id="selectOrganization" class="" title="" style="min-width: 150px;">
                <option value=""> TEST </option>
            </select>
        </div>
        <div class="mr10 fl"> 공간 </div>
        <div class="mr40 fl">
            <select id="selectSpace" class="" title="" style="min-width: 150px;">
                <option value=""> ALL </option>
            </select>
        </div>
        <div class="mr10 fl"> 조회월 </div>
        <div class="mr10 fl">
            <div class="mr10 fl">
                <select id="selectFromYear" class="" title="">
                    <option value="10"> 10 </option>
                </select>
            </div>
            <div class="mr10 fl"> 년 </div>
        </div>
        <div class="mr10 fl">
            <div class="mr10 fl">
                <select id="selectFromMonth" class="" title="">
                    <option value="10"> 10 </option>
                </select>
            </div>
            <div class="fl"> 월 </div>
        </div>
        <div class="mr10 fl"> ~ </div>
        <div class="mr10 fl">
            <div class="mr10 fl">
                <select id="selectToYear" class="" title="">
                    <option value="10"> 10 </option>
                </select>
            </div>
            <div class="mr10 fl"> 년 </div>
        ...
        <div class="mr10 fl">
            <div class="mr10 fl">
                <select id="selectToMonth" class="" title="">
                    <option value="10"> 10 </option>
                </select>
            </div>
            <div class="mr10 fl"> 월 </div>
        </div>
        <div id="searchMonth" class="mr10 fl">
            <div class="mr10 fl">
        ...
        <div class="mr10 fl">
            <button type="button" class="btn btn-default btnSearch btn-sm" id="btnSearch"> 조회 </button>
        </div>
    </div>
</div>
<div class="cl_b"></div>
