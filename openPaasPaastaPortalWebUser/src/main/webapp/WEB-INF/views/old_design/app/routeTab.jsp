...
<script>
    ...
    function initRouteTab(data){
        ...
        $.each(data.routes, function(eventID,eventData) {
            ...
            $("#urisBox").append(
                "<div style='height: 50px; line-height: 50px; margin-left: 3px'>" +
                    "<a href= 'http://"+uri+"' target='_blank'>"+uri+
                    "</a>"+
...
<div class="tab-title-box" style="background-color: #e2e3e4;">라우트
    <button type="button" style="float: right; margin:-3px" class="btn btn-save btn-sm" onclick="toggleBox('addRoute')">+ 연결</button>
</div>

<div class="tab-title-box" id="addRouteBox" style="display: none">

    <div class="inner-addon right-addon">
        <input id="addRoute-TextField" type="text" maxlength="200" class="form-control-warning" onkeyup="routeValidation('addRoute')" placeholder="추가할 호스트 이름을 입력하세요." style="width: 50%;">
        ...
        <div style="float:right; margin-top: 10px">
            ...
            <button id="btn-addRoute" type="button" class="btn btn-save btn-sm" onclick="addApplicationRoute('addRoute')" disabled="true">
                추가
            </button>
        </div>
    </div>
