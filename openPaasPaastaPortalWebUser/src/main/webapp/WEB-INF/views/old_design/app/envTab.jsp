...
<script>
    ...
    <div class="tab-title-box" style="background-color: #e2e3e4;">사용자 정의
        <button type="button" class="btn btn-save btn-sm" style="float: right; margin:-3px" onclick="toggleAddUserEnvBox()">+ 추가</button>
    </div>
    <div class="tab-title-box" id="addUserEnvBox" style="display: none;">
        <input class='form-control' id="envNameTextField" type='text' maxlength='100' placeholder="환경변수 이름" style='width: 70%; height: 35px; margin: 1px;'
               onkeyup="envInputValidation(envNameTextField.value, envValueTextField.value)">
        <input class='form-control' id="envValueTextField" type='text' maxlength='100' placeholder="값" style='width: 70%; height: 35px; margin: 1px;'
               onkeyup="envInputValidation(envNameTextField.value, envValueTextField.value)">

        <div style="float: right">
            <button type="button" class="btn btn-cancel btn-sm"
                    onclick="toggleAddUserEnvBox()">취소</button>
            <button id="btn-addUserEnv" type="button" class="btn btn-save btn-sm"
                    onclick="changeApplicationEnv('add',envNameTextField.value, envValueTextField.value)" disabled="true">추가</button>
        </div>
    </div>
...
<div style="margin-top: 10px">
    <div class="tab-title-box" style="margin-top: 10px; background-color: #e2e3e4;" >
        시스템 제공
    </div>
    <pre class="env-list-box" id="systemProvidedEnv" style="background-color: white; line-height: 20px; font-size: small">
    </pre>
