        ...
        <div class="panel content-box col-sm-12 col-md-12">
            ...
            <div>
                <div class="mt20 mb10 fr">
                    <button type="button" id="buttonMoveInsertForm" class="btn btn-primary btn-sm"> 글쓰기 </button>
                </div>

                <table id="boardTableArea" class="table table-striped table-hover t1">
                    <thead>
                    <tr>
                        <th>No.</th>
                        <th>제목</th>
                    ...
                    if (resultList[i].filePath != '') { // 파일 있으면
                        ...
                        htmlString.push('<tr id="trID" >'
                            ...
                            + '<td class="col-md-6" style="padding-left: '+ textIndent+'px;">'
                                ...
                                + ' <span> ' + thisComment + '</span>'
                            + '</td>'
                            + '<td class="col-md-1 tac">' + masking(resultList[i].userId) + '</td>'
                            + '<td class="col-md-1 tac">' + resultList[i].created.substring(0,10) + '</td>'
                            + '</tr>');
