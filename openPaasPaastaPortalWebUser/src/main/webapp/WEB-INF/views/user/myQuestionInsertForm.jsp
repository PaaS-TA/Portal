...
* 업    무    명 : 내 문의
* 프로그램명(ID) : myQuestionInserForm.jsp(내문의등록)
* 프로그램  개요 : 내 문의를 등록하는 화면
* 작    성    자 : 김도준
* 작    성    일 : 2016.08.24
=================================================================
수정자 / 수정일 :
    ...
    <div class="panel content-box col-sm-12 col-md-12 mt-5">
        ...
        <div class="panel content-box col-sm-12 col-md-12">
            <form id="myQuestionInsertForm" name="myQuestionInsertForm" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-1" for="reqFile"> 파일 </label>
                    <div class="col-sm-11">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body pd10" style="min-height: 48px;">
                                    ...
                                    <div id="fileDeleteButtonArea" class="ml10 fl" style="display: none;">
                                        <button type="button" id="btnDeleteFile" class="btn btn-save btn-sm" style="margin: 2px 0;"> 첨부파일 삭제 </button>
                                    </div>
                                    <div class="fr">
                    ...
                    <div class="">
                        ...
                        <c:choose>
                            <c:when test="${insertFlag eq checkCudU}">
                                ...
                                <button type="button" class="btn btn-point btn-sm" id="btnSave">저장</button>
                                <button type="button" class="btn btn-cancel btn-sm" id="btnCancel">취소</button>
                            </c:when>
                            <c:otherwise>
                                <button type="button" class="btn btn-point btn-sm" id="btnSave">등록</button>
                                <button type="button" class="btn btn-cancel btn-sm" id="btnCancel">취소</button>
                            </c:otherwise>
                        </c:choose>
                    </div>
