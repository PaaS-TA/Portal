...
<body>
<form name='login' action="<c:url value='/user/resetPassword'/>" method='GET'>
    <fieldset>
        ...
        <div class="w800px text-center">
            ...
            <c:if test="${empty success}">
                <div class="form-group text-center mt65 ">
                    ...
                    <div class="mt5"><span class="login-font2">등록된 계정의 비밀번호 재설정을 요청합니다.</span></div>
                </div>
                <div class="text-center mt15">
                    <input class="login-form" placeholder="yourmail@example.com" name="id" type="text" value="${id}" required="required" maxlength="100"
            ...
            <c:if test="${empty success}">
                <div class="text-center mt80">
                    <button name="submit" type="submit" class="btn btn-primary btn-lg" style="width:180px; background-color:#faa51b; border-color:#faa51b; font-weight: normal;">비밀번호 재설정</button>
                </div>
            </c:if>
        </div>
    </fieldset>
