        ...
        <div class="panel content-box col-sm-12 col-md-12">
            <form id="documentsForm" name="documentsForm" class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <div class="col-sm-11">
                        <input type="text" class="form-control modify_form_control" id="classification"
                               name="classification" maxlength="100" style="background: white; cursor: text" disabled>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-11">
                        <input type="text" class="form-control modify_form_control" id="title" name="title"
                               maxlength="100" style="background: white; cursor: text" disabled>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-11">
                        <textarea class="form-control modify_form_control" rows="10" id="content" name="content"
                                  style="background: white; cursor: text" disabled></textarea>
                    </div>
                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body pd10" style="min-height: 48px;">
                                    <div class="fl" style="margin: 3px 0 0 0;">
                                        <span id="fileIcon" class="glyphicon glyphicon-save-file"
