...
<div id="docoumentsViewArea">
    <div class="panel content-box col-sm-12 col-md-12 mt-5">
        ...
        <div class="panel content-box col-sm-12 col-md-12">
            ...
            <div>
                <table id="documentsTableArea" class="table table-bordered table-hover">
                    <thead>
                    <tr>
        ...
        if (listLength < 1) {
            ...
            for (var i = 0; i < listLength; i++) {
                ...
                htmlString.push('<tr>'
                        ...
                        + '<td class="col-md-7"><span id="titleId"  style="font-size: 15px;cursor:pointer;" onclick="procMoveDocumentsView(\'' + resultList[i].no + '\')">' + resultList[i].title + '</span>'
                        ...
                        + '</td>'
                        + '<td class="col-md-2 tac"><span style="font-size: 15px;">' + resultList[i].created.substring(0, 10) + '</td>' // substring(0,16)
                        + '</tr>');
            }
