...
<div class="form-group col-sm-4 mr-60" style="width: 39%; margin-left: -20px">
    ...
    <div class="col-sm-4" style="width: 300px">
            <input type='text' class="form-control" size="20" style="width: 130px; background:url(/resources/images/btn_cal.png) no-repeat right; border-radius: 5px 5px 5px 5px;" id='startDateInput'/>
        &nbsp;&nbsp;&nbsp;
        ~
        &nbsp;&nbsp;
...
<div class="form-group col-sm-2 mr-25" style="width: 20%;padding-left:20px">
    <label for="searchTypeColumn" class="control-label-gray col-sm-6 mt13 ml-10"
...
<div class="form-group col-sm-2 mr-25" style="width: 19%;padding-left:0px">
    <label for="searchTypeUseYn" class="control-label-gray col-sm-6 mt13 ml-10"
