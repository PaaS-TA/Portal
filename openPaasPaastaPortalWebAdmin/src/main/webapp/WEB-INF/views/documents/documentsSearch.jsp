...
<div class="form-group col-sm-4 mr-60" style="width: 39%">
    ...
    <div class="col-sm-4" style="width: 300px">
            <input type='text' class="form-control" size="20" style="width: 130px; background:url(/resources/images/btn_cal.png) no-repeat right;  border-radius: 5px 5px 5px 5px;" id='startDateInput-documents'/>
        &nbsp;&nbsp;&nbsp;
        ~
        &nbsp;&nbsp;
            <input type='text' class="form-control" size="20" style="width: 130px; background:url(/resources/images/btn_cal.png) no-repeat right;  border-radius: 5px 5px 5px 5px;" id='endDateInput-documents'/>
...
<div class="form-group col-sm-2 mr-25" style="width: 19%">
    <label for="searchTypeColumn" class="control-label-gray col-sm-6 mt13 ml-10" style="text-align:right;">검색항목&nbsp;&nbsp; </label>
    <div class="col-sm-6">
        <select id="searchTypeColumn" name="searchTypeColumn" class="form-control" style="background:url(/resources/images/btn_down.png) no-repeat right;">
...
<div class="form-group col-sm-2 mr-25" style="width: 19%">
    <label for="searchTypeUseYn" class="control-label-gray col-sm-6 mt13 ml-10" style="text-align:right;">공개여부&nbsp;&nbsp; </label>
    <div class="col-sm-6">
        <select id="searchTypeUseYn" name="searchTypeUseYn" class="form-control" style="background:url(/resources/images/btn_down.png) no-repeat right;">
            <option value="<%= Constants.SEARCH_TYPE_ALL %>">전체</option>
...
<div class="form-group col-sm-4" style="width: 29%">
    <label for="searchKeyword" class="control-label-gray col-sm-3 mt13 ml-10" style="text-align:right;width:28%">검색어&nbsp;</label>
